  ...
  Proven experience in developing Multi-Agent systems, RAG-based chatbots, and scalable AI-driven solutions.
          ...
          >
            <div className="relative w-72 h-[380px] md:w-[350px] md:h-[460px] mx-auto group">
              {/* Rounded Rectangular Container with Premium Border */}
              <div 
                className="w-full h-full rounded-[2.5rem] p-[3px] bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 shadow-[0_0_30px_rgba(59,130,246,0.2)] relative"
              >
                <div className="w-full h-full rounded-[2.3rem] overflow-hidden bg-gray-950 relative">
                  <Image
                    src="/profile.png"
                    alt="Vaibhav Sable Profile Photo"
                    fill
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-950/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center p-6 pointer-events-none">
