              ...
              >
                ...
                <div className={`md:w-1/2 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'} pl-8 md:pl-0`}>
                  <div className="bg-gray-900 p-6 rounded-lg shadow-md border border-gray-700">
                    ...
                    {exp.projectImage && (
                      <div className="mt-4 relative aspect-video w-full overflow-hidden rounded-lg border border-gray-700">
                        <Image
                    ...
                    {/* Certificates & Project Code Section */}
                    {((exp.certificates && exp.certificates.length > 0) || exp.githubUrl) && (
                      <div className="mt-4 pt-4 border-t border-gray-700 space-y-4">
                        ...
                        {exp.githubUrl && (
                          <div>
                            <div className="flex items-center mb-3">
                              <FiGithub className="w-4 h-4 mr-2 text-yellow-500" />
                              <h5 className="text-sm font-bold text-white">Project Source Code</h5>
                            </div>
                            <div className="flex flex-wrap gap-3">
                              <a
                                href={exp.githubUrl}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group relative inline-flex items-center px-4 py-2.5 bg-yellow-500 hover:bg-yellow-600 text-gray-900 text-sm font-semibold rounded-lg shadow-md hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300 overflow-hidden"
                              >
                                {/* Shine effect */}
                                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent opacity-0 group-hover:opacity-20 transform -skew-x-12 group-hover:translate-x-full transition-all duration-700"></div>
                                
                                <FiGithub className="w-4 h-4 mr-2 relative z-10" />
