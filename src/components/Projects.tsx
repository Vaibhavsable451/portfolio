...
import { FiGithub, FiExternalLink, FiPlay, FiX, FiCpu, FiVolume2, FiVolumeX, FiDownload } from 'react-icons/fi';
...
const Projects = () => {
  ...
  title: 'AegisAI — Enterprise AI Governance Agent',

  description:
    'Enterprise AI governance agent built with Microsoft Foundry and Microsoft Azure. Uses Azure AI Search, MCP, Agentic RAG, and GPT-5-mini to retrieve grounded answers from enterprise policies and documents. Supports Chat + Voice interactions with security-aware access control through Azure IAM. Designed to reduce hallucinations and provide policy-grounded, enterprise-ready AI assistance.',

  image: '/Foundryagent.mp4',
  ...
  githubUrl: 'https://github.com/Vaibhavsable451/AegisAI-Enterprise-AI-Governance-Agent.git'
},
    {
      id: 2,
    
      title: 'RAG Assistant — Groq + LangChain + MCP + AI Governance',
    
      description: 'Enterprise RAG application built with Groq, LangChain, FAISS, Streamlit, MCP, Presidio, Pytest, GitHub Actions, and Azure App Service. Features governed RAG retrieval, PII redaction, moderation, JSONL audit logging, MCP tool interoperability, automated testing, and CI/CD deployment to Microsoft Azure. Designed to extend a traditional RAG pipeline with security, governance, interoperability, testing, and cloud deployment.',
      ...
      githubUrl: 'https://github.com/Vaibhavsable451/RAG-Assistant-Enterprise-RAG-with-LangChain-MCP.git',
      liveUrl: 'https://neuraguard-g8fccxd4fmeafbgm.westus3-01.azurewebsites.net/',
    },
    {
  id: 3,

  title: 'AI Governance & ML Observability Platform',

  description: 'End-to-end AI/ML governance platform for monitoring, evaluating, securing, and governing production AI systems. Includes RAG, LLM evaluation, drift detection, fairness, explainability, PII protection, risk scoring, Human-in-the-Loop review, audit logging, and AWS observability.',

  image: '/Deeplaerning.mp4',

  poster: '/Deeplaerning1.png',
  ...
  githubUrl: 'https://github.com/Vaibhavsable451/-ML-Governance-AI-Observability-Platform.git',

  liveUrl: 'http://16.192.79.15:30080/',
...
},
    {
      ...
      title: 'NeuraGuard — Enterprise Agentic AI Control & Governance Platform',
    
      description: 'Enterprise Agentic AI control and governance platform built with FastAPI, Streamlit, LangChain, LangGraph, Pinecone, Groq, and GitHub Actions. Features 11 RAG strategies, 8 LangGraph agents, AI governance, automated red-teaming, observability, AI FinOps, incident self-healing, and human-in-the-loop approval workflows. Designed as a production-oriented platform for securing, evaluating, monitoring, and controlling agentic AI systems.',
    
      image: '/incidents.mp4',
    
      poster: '/incidents1.png',
      ...
      githubUrl: 'https://github.com/Vaibhavsable451/NeuraGuard-Enterprise-Agentic-AI-Control-Governance-Platform.git'
    },
    {
  id: 5,
  ...
  githubUrl:
    'https://github.com/Vaibhavsable451/AegisAI-Enterprise-AI-Governance-Agentic-RAG-Platform.git',

  architectureImage: '/aegis_ai_architecture.png'
},
 {
      id: 6,
      ...
      poster: '/customer-support-platform.png',
      technologies: [
        'Python',
        'FastAPI',
        'LangGraph',
    ...
    },
    {
      ...
      description: 'A multi-agent AI system that automates end-to-end research workflows using LangChain and Groq LLMs with search, extraction, generation, and evaluation capabilities.',
      image: '/streamlit.png',
      technologies: [
        'Python',
        'LangChain',
  ...
  description: 'An end-to-end Machine Learning application that predicts house prices using supervised learning. Built with Python, Scikit-learn, and Streamlit, featuring data preprocessing, model comparison, EDA visualizations, real-time predictions, and downloadable prediction reports.',
  image: '/MLPROJECT.mp4',
  poster: '/MLPROJECT.png',
  ...
  githubUrl: 'https://github.com/Vaibhavsable451/ai-house-price-prediction.git',
  liveUrl: 'https://ai-house-price-predictiongit-kmgbklloflzpqobtfj2pkz.streamlit.app/'
},
    {
      id: 10,
  ...
  githubUrl: 'https://github.com/Vaibhavsable451/AI-Sales-Intelligence-Agent',
  ...
  liveUrl: 'https://resdasales.netlify.app/'
...

    {
      ...
      githubUrl: 'https://github.com/Vaibhavsable451/ResumeForgeAI-Multi-Agent-ATS-Resume-Builder-',
    ...
    },
    {
      ...
      poster: '/sales-support-agent.png',
      technologies: [
        'n8n',
        'Groq',
        'Llama 3.3 70B',
      ...
      githubUrl: 'https://github.com/Vaibhavsable451/multi_agent_sales_support',
    ...
    },
    {
      ...
      poster: '/cricket-multi-agent.png',
      technologies: [
        'n8n',
        'Groq',
        'Llama 3.3 70B',
...
},
{
  ...
  // ── Generate & download full projects PDF ──
  const generatePDF = () => {
...
<head>
  <meta charset="UTF-8" />
  <title>Vaibhav Sable — Projects Portfolio</title>
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: 'Segoe UI', Arial, sans-serif; background: #fff; color: #1a1a2e; padding: 32px; }
    h1 { font-size: 28px; text-align: center; color: #1e3a8a; margin-bottom: 4px; }
    .subtitle { text-align: center; color: #64748b; font-size: 13px; margin-bottom: 32px; }
    .divider { height: 3px; background: linear-gradient(90deg,#3b82f6,#8b5cf6); border-radius: 9px; margin-bottom: 32px; }
    .project { border: 1px solid #e2e8f0; border-radius: 12px; padding: 20px 24px; margin-bottom: 24px; page-break-inside: avoid; }
    .project-num { font-size: 11px; color: #94a3b8; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 4px; }
    .project-title { font-size: 17px; font-weight: 800; color: #1e3a8a; margin-bottom: 8px; }
    .project-desc { font-size: 12.5px; color: #374151; line-height: 1.7; margin-bottom: 12px; }
    .tech-wrap { display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: 12px; }
    .tech-tag { background: #dbeafe; color: #1d4ed8; border-radius: 999px; padding: 2px 10px; font-size: 11px; font-weight: 600; }
    .links { display: flex; gap: 12px; flex-wrap: wrap; font-size: 12px; }
    .links a { color: #2563eb; text-decoration: none; font-weight: 600; }
    .links a:hover { text-decoration: underline; }
    .badge { display: inline-block; background:#f0fdf4; color:#16a34a; border: 1px solid #bbf7d0; border-radius:6px; padding:1px 8px; font-size:11px; font-weight:700; }
    @media print {
      body { padding: 16px; }
...
<body>
  <h1>🚀 Vaibhav Sable — Full Project Portfolio</h1>
  <p class="subtitle">${projects.length} Projects · AI Engineering · Full Stack · Cloud · Automation</p>
  <div class="divider"></div>
  <div class="no-print" style="text-align:center;margin-bottom:24px">
    <button onclick="window.print()" style="background:#1e3a8a;color:#fff;border:none;padding:10px 28px;border-radius:8px;font-size:14px;font-weight:700;cursor:pointer">⬇ Save as PDF</button>
  </div>
  ${projects.map((p, i) => `
  <div class="project">
    ...
    <div class="tech-wrap">${p.technologies.map(t => `<span class="tech-tag">${t}</span>`).join('')}</div>
    <div class="links">
      ${p.githubUrl ? `<a href="${p.githubUrl}" target="_blank">⌥ GitHub</a>` : ''}
      ${p.liveUrl ? `<a href="${p.liveUrl}" target="_blank">🔗 Live Demo</a>` : ''}
      ${p.architectureImage ? `<span class="badge">Architecture Diagram</span>` : ''}
    </div>
  </div>`).join('')}
</body>
</html>`;
  ...
  return (
    <section id="projects" className="py-20 bg-gray-950 overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              download="Vaibhav_Sable_Projects_Portfolio.pdf"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold rounded-xl shadow-lg shadow-blue-500/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-blue-500/50 cursor-pointer text-sm"
            >
              <FiDownload className="w-4 h-4" />
              Download PDF File ({projects.length} Projects)
            </a>
            <button
              onClick={generatePDF}
              className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 text-white border border-white/20 font-bold rounded-xl shadow-lg backdrop-blur-md transition-all duration-300 hover:-translate-y-1 cursor-pointer text-sm"
            >
              <FiExternalLink className="w-4 h-4" />
              Print / Export Live PDF
            </button>
          </div>
        </motion.div>
                    ...
                    <>
                      {isClient && project.image?.toLowerCase().endsWith('.mp4') ? (
                        ...
                        <Image
                          ...
                          style={{ objectFit: project.title.includes('Customer Support') ? 'contain' : 'cover' }}
              ...
              <div className="lg:w-1/2">
                ...
                <div className="flex flex-wrap gap-3 items-center">
                  ...
                  {project.backendUrl && (
                    ...
                    >
                      Backend ({project.title.includes('Sales Intelligence') ? 'Vercel' : 'Render'})
                    </span>
                  )}
                  {project.frontendUrl && (
                    <span
                    ...
                    >
                      Frontend ({project.title.includes('House Price') || project.title.includes('Sales Intelligence') ? 'Vercel' : 'Render'})
                    </span>
                  )}
                  {project.githubUrl && (
                    <a
        ...
        {showVideo && selectedVideo && (
          <div
            className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4 md:p-6 backdrop-blur-md"
            onClick={() => handleVideoToggle()}
          >
            <button
              className="absolute top-4 right-4 text-white hover:text-gray-300 transition-colors z-30 bg-gray-800/80 p-2.5 rounded-full cursor-pointer shadow-lg hover:bg-gray-700"
              onClick={(e) => {
                e.stopPropagation();
                handleVideoToggle();
              }}
            ...
            <div
              className="w-full max-w-5xl md:max-w-6xl relative overflow-hidden rounded-2xl shadow-2xl bg-black border border-white/10"
            ...
            >
              ...
              <video
                ref={modalVideoRef}
                src={encodeURI(selectedVideo)}
                controls
                autoPlay
                playsInline
                preload="auto"
                className="w-full max-h-[85vh] aspect-video object-contain bg-black rounded-2xl"
                key={selectedVideo}
              ...
              {!isPlaying && !isVideoLoading && (
                <div
                  ...
                  onClick={() => {
                    if (modalVideoRef.current) {
                      modalVideoRef.current.play().then(() => setIsPlaying(true)).catch(console.error);
                    }
                  }}
                >
                  <div className="flex items-center gap-3 px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-full font-bold shadow-2xl transform hover:scale-105 transition-all">
                    <FiPlay size={24} />
